...
// runtime polymorphism? virtual functions? ---> gave rise more than necessary OOP
// static_cast, dynamic_cast, reinterpret_cast, const_cast, C style casts (wilder form of casting)
